export const mockHiscoreResponse = {
  ...
  skills: [
    ...
    { id: 3, name: 'Strength', rank: 868700, level: 96, xp: 9736256 },
    { id: 4, name: 'Hitpoints', rank: 895580, level: 95, xp: 9180591 },
    { id: 5, name: 'Ranged', rank: 1067251, level: 90, xp: 5440060 },
    { id: 6, name: 'Prayer', rank: -1, level: 1, xp: -1 },
    { id: 7, name: 'Magic', rank: 850983, level: 94, xp: 7998100 },
    { id: 8, name: 'Cooking', rank: 1991375, level: 67, xp: 598535 },
    ...
    { id: 13, name: 'Crafting', rank: 1966087, level: 61, xp: 302454 },
    { id: 14, name: 'Smithing', rank: 1452755, level: 67, xp: 557874 },
    { id: 15, name: 'Mining', rank: -1, level: 1, xp: -1 },
    { id: 16, name: 'Herblore', rank: -1, level: 1, xp: -1 },
    { id: 17, name: 'Agility', rank: -1, level: 1, xp: -1 },
    { id: 18, name: 'Thieving', rank: 1797478, level: 54, xp: 154853 },
  ...
  activities: [
    ...
    { id: 14, name: 'LMS - Rank', rank: 146633, score: 712 },
    { id: 15, name: 'PvP Arena - Rank', rank: 1820, score: 3367 },
    ...
    { id: 64, name: 'Skotizo', rank: -1, score: -1 },
    ...
    { id: 75, name: 'Theatre of Blood: Hard Mode', rank: -1, score: -1 },
    { id: 76, name: 'Thermonuclear Smoke Devil', rank: -1, score: -1 },
    { id: 77, name: 'Tombs of Amascut', rank: -1, score: -1 },
    { id: 78, name: 'Tombs of Amascut: Expert Mode', rank: -1, score: -1 },
    ...
    { id: 87, name: 'Zalcano', rank: -1, score: -1 },
    { id: 88, name: 'Zulrah', rank: -1, score: -1 },
  ],
}
